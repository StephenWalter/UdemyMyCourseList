...
class MySpider02(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # code for Traversing Options => outputBooks02a.csv - cannot get the title working no matter what I try!!!!!!
        #item['title'] = response.xpath("//div[@class='col-sm-6 product_main']/text()").get()
